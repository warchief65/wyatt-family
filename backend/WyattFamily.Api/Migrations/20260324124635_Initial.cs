        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateDisplay = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentTags_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ContentTags_MediaItems_MediaItemId",
                        column: x => x.MediaItemId,
                        principalTable: "MediaItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ContentTags_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContentTags_Stories_StoryId",
                        column: x => x.StoryId,
                        principalTable: "Stories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentTags_DocumentId",
                table: "ContentTags",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_ContentTags_MediaItemId",
                table: "ContentTags",
                column: "MediaItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ContentTags_PersonId",
                table: "ContentTags",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_ContentTags_StoryId",
                table: "ContentTags",
                column: "StoryId");
